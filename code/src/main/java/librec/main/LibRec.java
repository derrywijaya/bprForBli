...
import librec.ranking.AllNNBPRE;
...
import librec.ranking.CBPRExtended;
import librec.ranking.CLiMF;
import librec.ranking.COBPR;
import librec.ranking.CSBPR;
import librec.ranking.FISMauc;
import librec.ranking.FISMrmse;
import librec.ranking.GBPR;
import librec.ranking.INNBPRE;
import librec.ranking.INNBPRENorm;
import librec.ranking.ImagesNNB;
import librec.ranking.ImagesNNBPRE;
import librec.ranking.ImagesNNBPREB;
import librec.ranking.ItemBigram;
import librec.ranking.JustWikiBPR;
import librec.ranking.JustWikiNNBPRE;
import librec.ranking.KitchenNNBPRE;
import librec.ranking.KitchenNNBPREB;
import librec.ranking.LDA;
import librec.ranking.LNBPR;
import librec.ranking.LRMF;
import librec.ranking.LoanNNBPRE;
import librec.ranking.NNBPR;
import librec.ranking.NNBPRE;
//import librec.ranking.PPDBCompletionBPR;
import librec.ranking.RankALS;
import librec.ranking.RankSGD;
import librec.ranking.SBPR;
import librec.ranking.SLIM;
import librec.ranking.VBPR;
import librec.ranking.VNBPR;
import librec.ranking.WBPR;
import librec.ranking.WRMF;
import librec.ranking.WikiBPR;
import librec.ranking.WikiNNBPRE;
import librec.ranking.WikiNNBPRETransliteration;
import librec.ranking.WikiNNBPRETransliterationCombined;
import librec.ranking.WikiThirdBPR;
import librec.ranking.contextOnlyBPR;
import librec.ranking.contextOnlyBPRImages;
import librec.ranking.imageOnlyBPR;
import librec.ranking.imageOnlyBPRImages;
...
public class LibRec {
	...
	protected Recommender getRecommender(SparseMatrix[] data, int fold) throws Exception {
		...
		case "wikibpr":
			return new WikiBPR(trainMatrix, testMatrix, fold);
		case "wikithirdbpr":
			return new WikiThirdBPR(trainMatrix, testMatrix, fold);
		case "justwikibpr":
			return new JustWikiBPR(trainMatrix, testMatrix, fold);
		case "cbpr":
			return new CBPR(trainMatrix, testMatrix, fold);
		case "cbprextended":
			return new CBPRExtended(trainMatrix, testMatrix, fold);
		case "cabpr":
			return new CABPR(trainMatrix, testMatrix, fold);
		case "nnbpr":
			return new NNBPR(trainMatrix, testMatrix, fold);
		case "justwikinnbpre":
			return new JustWikiNNBPRE(trainMatrix, testMatrix, fold);
		case "wikinnbpre":
			return new WikiNNBPRE(trainMatrix, testMatrix, fold);
		case "wikinnbpretransliteration":
			return new WikiNNBPRETransliteration(trainMatrix, testMatrix, fold);
		case "wikinnbpretransliterationcombined":
			return new WikiNNBPRETransliterationCombined(trainMatrix, testMatrix, fold);
		//case "ppdbcompletionbpr":
			//return new PPDBCompletionBPR(trainMatrix, testMatrix, fold);
		case "loannnbpre":
			return new LoanNNBPRE(trainMatrix, testMatrix, fold);
		case "kitchennnbpre":
			return new KitchenNNBPRE(trainMatrix, testMatrix, fold);
		case "allnnbpre":
			return new AllNNBPRE(trainMatrix, testMatrix, fold);
		case "kitchennnbpreb":
			return new KitchenNNBPREB(trainMatrix, testMatrix, fold);
		case "imagesnnbpre":
			return new ImagesNNBPRE(trainMatrix, testMatrix, fold);
		case "imagesnnb":
			return new ImagesNNB(trainMatrix, testMatrix, fold);
		case "imagesnnbpreb":
			return new ImagesNNBPREB(trainMatrix, testMatrix, fold);
		case "innbpre":
			return new INNBPRE(trainMatrix, testMatrix, fold);
		case "innbprenorm":
			return new INNBPRENorm(trainMatrix, testMatrix, fold);
		case "nnbpre":
			return new NNBPRE(trainMatrix, testMatrix, fold);
		case "vnbpr":
			return new VNBPR(trainMatrix, testMatrix, fold);
		case "vbpr":
			return new VBPR(trainMatrix, testMatrix, fold);
		case "contextonlybpr":
			return new contextOnlyBPR(trainMatrix, testMatrix, fold);
		case "contextonlybprimages":
			return new contextOnlyBPRImages(trainMatrix, testMatrix, fold);
		case "imageonlybpr":
			return new imageOnlyBPR(trainMatrix, testMatrix, fold);
		case "imageonlybprimages":
			return new imageOnlyBPRImages(trainMatrix, testMatrix, fold);
		case "lnbpr":
		...
		case "cobpr":
			return new COBPR(trainMatrix, testMatrix, fold);
		case "wbpr":
